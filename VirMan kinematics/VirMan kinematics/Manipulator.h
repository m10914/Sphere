...
#pragma comment(lib, "virman kinlib/d3dx9.lib")
#include "Windows.h"
#include "virman kinlib/d3dx9math.h"
#include "log.h"
...
public:
	...
	HRESULT InversedKinematics(D3DXVECTOR3 vecDesc, LPWSTR limbName, BOOL bTryToReach = false);
	HRESULT InversedKinematicsPrecalc(LPWSTR limbName, LPWSTR filename);
