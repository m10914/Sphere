...
CBaseCamera::CBaseCamera()
{
    ...
    SetViewParams( &vEyePt, &vLookatPt, &D3DXVECTOR3(0,1,0) );
...
//--------------------------------------------------------------------------------------
VOID CBaseCamera::SetViewParams( D3DXVECTOR3* pvEyePt, D3DXVECTOR3* pvLookatPt, D3DXVECTOR3* vUp )
{
...
{
    SetViewParams( &m_vDefaultEye, &m_vDefaultLookAt, &D3DXVECTOR3(0,1,0) );
}
...
//--------------------------------------------------------------------------------------
void CModelViewerCamera::SetViewParams( D3DXVECTOR3* pvEyePt, D3DXVECTOR3* pvLookatPt, D3DXVECTOR3* vUp )
{
    CBaseCamera::SetViewParams( pvEyePt, pvLookatPt, vUp );
